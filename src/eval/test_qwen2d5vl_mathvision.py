...
ds_split_list = ["testmini"]#["testmini", "test"]
max_new_tokens = 2048
...
MODEL_PATH_list = [
    ...
    "/checkpoint_mount/r1-v-3b-v2/exp-Qwen2.5-VL-3B-concat_visual_data_w_rec_139k/checkpoint-7300",
    "/checkpoint_mount/r1-v-3b-v2/exp-Qwen2.5-VL-3B-concat_visual_data_w_rec_139k/checkpoint-7400",
    "/checkpoint_mount/r1-v-3b-v2/exp-Qwen2.5-VL-3B-concat_visual_data_w_rec_139k/checkpoint-7500",
    ...
    # "/checkpoint_mount/r1-v-3b-text-math-collected-44k-v0/exp-Qwen2.5-VL-3B-orz_math_57k_collected_44k/checkpoint-4600",
]
...
for MODEL_PATH in MODEL_PATH_list:
    ...
    for data_split in ds_split_list:
        ...
        for example in sub_ds:
            ...
            message = [{
                ...
                "content": [
                    ...
                    {
                        "type": "text",
                        "text": SYSTEM_PROMPT + "\nQuestion: " + QUESTION_TEMPLATE.format(Question=input_q),## if "checkpoint" in MODEL_PATH else Origin_QUESTION_TEMPLATE.format(Question=input_q)
                    }
                ]
            }]
        ...
        # minglingfeng fix
        # max_new_tokens = 1024 #2048 if "checkpoint" in MODEL_PATH else 1024
