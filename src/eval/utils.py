...
# from latex2sympy2_extended import NormalizationConfig, latex2sympy2
# import re
...
# def evaluate_mathvision(content, sol, raw_example, **kwargs):
...
#             if "options"in raw_example and len(raw_example['options']) > 0:
#                 gt_answer_value = raw_example['options'][ord(ground_truth)-ord('A')]
#             else:
#                 gt_answer_value = ''
...
#             if reward == 0.0:
#                 if process_expression(ground_truth) == process_expression(student_answer):
#                     reward = 1.0
...
#                 reward = is_equal(ground_truth, model_answer) or is_equal(gt_answer_value, model_answer)
