# MODEL_PATH_list=/checkpoint_mount/r1-v-3b-text-math-collected-44k-v0/exp-Qwen2.5-VL-3B-orz_math_57k_collected_44k/checkpoint-6250
MODEL_PATH_list=/data_train2/mllm/minglingfeng/code/R1-V/model_ckpts/r1-v-3b-text-mathlv-345-v1/exp-Qwen2.5-VL-3B-text_mathlv_345/checkpoint-1154/
...
MODEL_PATH_list=/global_data/mllm/minglingfeng/models/Qwen2.5-VL-3B-Instruct,/checkpoint_mount/r1-v-3b-v2/exp-Qwen2.5-VL-3B-concat_visual_data_w_rec_139k/checkpoint-8400,/checkpoint_mount/r1-v-3b-v2/exp-Qwen2.5-VL-3B-concat_visual_data_w_rec_139k/checkpoint-8500,/checkpoint_mount/r1-v-3b-text-math-collected-44k-v0/exp-Qwen2.5-VL-3B-orz_math_57k_collected_44k/checkpoint-6250
batch_size=8
