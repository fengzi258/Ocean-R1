...
for MODEL_PATH in MODEL_PATH_list:
    ...
    OUTPUT_PATH=f"/data_train2/mllm/minglingfeng/code/R1-V/src/eval/logs/eval/superclevr_test200_counting_grpo_{ckpt_name}.json"
    PROMPT_PATH="/data_train2/mllm/minglingfeng/code/R1-V/src/eval/prompts/superclevr_test200_counting_problems.jsonl"
    ...
    img_dir = "/data_train2/mllm/minglingfeng/code/R1-V/src/eval/Super_CLEVR/"
